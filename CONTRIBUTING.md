...
Go to [the Github issue tracker](https://github.com/nordicenergy/ev-server/issues?state=open) and find an open issue which needs additional work or a bugfix. Maybe you can even find and [contribute](#contribute-code) a bugfix?
